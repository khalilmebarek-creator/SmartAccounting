...
class UserTestingView(BaseView):
    ...
    def _build_session_card(self):
        ...
        self.tester_edit.setMinimumHeight(36)
        ...
        self.scenario_combo.setMinimumHeight(36)
    ...
    def _build_feedback_card(self):
        ...
        self.rating_spin.setMinimumHeight(36)
