...
class RatiosView(QWidget):
    ...
    def setup_ui(self):
        ...
        profitability_grid.addWidget(self.cards['net_profit_margin'], 0, 1)
        ...
        efficiency_grid.addWidget(self.cards['inventory_turnover'], 1, 0)
        efficiency_grid.addWidget(self.cards['days_sales_outstanding'], 1, 1)
