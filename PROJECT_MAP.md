...
> **آخر حالة (2026-08-05):** v3.1.8+ — **1877 اختباراً** (1862 + 15 توحيد واجهات) + تغطية وحدات 100% + 1986 مفتاح i18n × 3 لغات + **معايير تباعد/هوامش/أحجام موحّدة (ui/constants.py + apply_standard_layout) مطبّقة على الشاشات الـ35 والثيمات الثلاثة** (min-height 40 = حقول 42-44px/أزرار 42px) + doc UI_STYLE_GUIDE/UI_SPACING_AUDIT_REPORT. الجدول أدناه سجل تاريخي؛ أرقام الجلسات القديمة تعكس حالتها وقتها.
