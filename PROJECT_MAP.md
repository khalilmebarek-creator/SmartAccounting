...
> **آخر حالة (2026-08-05):** v3.1.8+ — **1991 اختباراً** + تغطية وحدات 100% + 2011 مفتاح i18n × 3 لغات + معايير واجهات موحّدة + المرحلة 1 من التنظيم الشامل + **Module 1 ترخيص RSA-2048 offline** + **Module 2 تشفير AES-256-GCM + Argon2id** (سنابات المزامنة السحابية بقاعدة بيانات خلفية كاملة للقديم) + **Module 3 بوابات طبقات مفعّلة** (cloud_sync=PRO، ai_unlimited=ENTERPRISE — محلياً في نقاط الدخول بلا كسر المحرّكات). الجدول أدناه سجل تاريخي؛ أرقام الجلسات القديمة تعكس حالتها وقتها.
