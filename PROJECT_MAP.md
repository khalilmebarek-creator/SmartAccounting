...
> **آخر حالة (2026-08-05):** v3.1.8+ — **1877 اختباراً** + تغطية وحدات 100% + 1986 مفتاح i18n × 3 لغات + **معايير تباعد/هوامش/أحجام موحّدة (ui/constants.py + apply_standard_layout) مطبّقة على الشاشات الـ35 والثيمات الثلاثة** (min-height 40 = حقول 42-44px/أزرار 42px) + **المرحلة 1 من التنظيم الشامل**: نافذة متكيفة مع شاشة المستخدم (1920×1080 أو حسب الدقة) + شريط حالة 40px بملصق إصدار + صفوف جداول 44px برمجياً + تبويبات/شريط تمرير أفقي للفاتح. الجدول أدناه سجل تاريخي؛ أرقام الجلسات القديمة تعكس حالتها وقتها.
