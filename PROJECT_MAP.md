...
> **آخر حالة (2026-08-05):** v3.1.8+ — **1944 اختباراً** + تغطية وحدات 100% + 2007 مفتاح i18n × 3 لغات + معايير واجهات موحّدة + المرحلة 1 من التنظيم الشامل (نافذة متكيفة/شريط حالة/صفوف 44px) + **Module 1 تجاري: ترخيص RSA-2048 بتنشيط offline (tiers Free/Pro/Enterprise + مهلة 14 يوم + hardware fingerprint + حوار تفعيل + keygen للبائع)**. الجدول أدناه سجل تاريخي؛ أرقام الجلسات القديمة تعكس حالتها وقتها.
