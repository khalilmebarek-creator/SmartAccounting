...
> **آخر حالة (2026-08-16):** v3.2.0 — **2071 اختباراً** (سطح المكتب) + **56 اختباراً Flutter** (mobile/) + **تطبيق جوال Android** (arm64 18.2MB) + تغطية وحدات 100% + 2105 مفتاح i18n × 3 + **شريط Ribbon 7 تبويبات** + **إصلاح انهيار matplotlib** + **ML مفعّل كاملاً** + **تقارير IAS/IFRS** + **منصة ذكاء اصطناعي متكاملة** + **توحيد تصميم الشاشات المحاسبية الأربع (34-37)**.
