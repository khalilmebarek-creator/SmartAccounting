...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ar: {
            ...
            upd_new30: 'اختبار UAT شامل كمستخدمين حقيقيين: رحلة مستخدم كاملة عبر التطبيق (تسجيل دخول + تجوّل الشاشات الـ35 + إدخال بيانات + تبديل 3 لغات + حفظ + تسجيل خروج) — 1786 اختباراً ناجحاً + كشف وإصلاح بغّ حقيقي عند تبديل اللغة في شاشتي المزامنة البنكية واستيراد البيانات',
        ...
        en: {
            ...
            upd_new30: 'Comprehensive UAT as real users: a full user journey through the app (login + navigating all 35 screens + data entry + switching 3 languages + saving + logout) — 1786 passing tests + discovered and fixed a real bug when switching language on the bank-sync and data-import screens',
        ...
        fr: {
            ...
            upd_new30: 'UAT complet en tant qu\'utilisateurs réels : parcours utilisateur complet dans l\'application (connexion + navigation dans les 35 écrans + saisie de données + basculement de 3 langues + enregistrement + déconnexion) — 1786 tests réussis + découverte et correction d\'un vrai bug lors du changement de langue sur les écrans de synchro bancaire et d\'import de données',
