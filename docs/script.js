...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ar: {
            ...
            hero_badge: 'v3.1.0 — مشروع تخرج محاسبي',
            ...
            upd_new1: 'إصلاح استعادة كلمة المرور بنظام الرمز الآمن',
            upd_new2: 'إظهار/إخفاء كلمة المرور',
        ...
        en: {
            ...
            nav_updates: 'Updates',
            hero_badge: 'v3.1.0 — Master\'s Graduation Project',
            ...
            upd_new1: 'Fixed password recovery with secure code system',
            upd_new2: 'Password visibility toggle (eye icon)',
            ...
            upd4: '22 screens — 322 tests — 7 industrial sectors',
        ...
        fr: {
            ...
            hero_badge: 'v3.1.0 — Projet de fin d\'étude Master',
            ...
            upd_new1: 'Récupération du mot de passe avec système de code sécurisé',
            upd_new2: 'Bascule d\'affichage du mot de passe (icône œil)',
            ...
            upd4: '22 écrans — 322 tests — 7 secteurs industriels',
