...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ar: {
            ...
            intro: 'مشروع تخرج محاسبي متكامل يجمع بين <strong>الذكاء الاصطناعي</strong> و<strong>النظام الجبائي الجزائري</strong> — يتضمن 22 شاشة تفاعلية، 28 نسبة مالية، و351 اختبار وحدة ناجح.',
            ...
            upd4: '22 شاشة — 351 اختبار — 7 قطاعات صناعية',
