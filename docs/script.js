...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ar: {
            ...
            intro: 'مشروع تخرج محاسبي متكامل يجمع بين <strong>الذكاء الاصطناعي</strong> و<strong>النظام الجبائي الجزائري</strong> — يتضمن 35 شاشة تفاعلية، 20 نسبة مالية + Z-Score، و1656 اختبار وحدة ناجح.',
            ...
            about_card3_desc: '43 وحدة برمجية مستقلة — سهل التوسيع والصيانة والتطوير',
            ...
            mod18: 'دفتر الأستاذ',
            mod18_desc: 'قيود يومية + دفتر أستاذ + ميزان مراجعة',
            mod19: 'العملاء والموردون',
            mod19_desc: 'شركاء + معاملات + أرصدة + تقادم الديون',
            mod20: 'الفواتير',
            mod20_desc: 'بيع/شراء + عناصر + TVA + حالات',
            mod21: 'المخزون',
            mod21_desc: 'عناصر + حركات + متوسط تكلفة + تنبيهات',
            mod22: 'الرواتب الجزائرية',
            mod22_desc: 'موظفون + CNAS + IRG + كشوفات رواتب',
            mod23: 'الميزانية',
            mod23_desc: 'بنود + مقارنة بالفعلي + انحراف',
            ...
            upd_date11: '2 أغسطس 2026',
            upd_new28: 'المرحلة الثانية — 6 شاشات محاسبية جديدة: دفتر الأستاذ العام (ميزان مراجعة) + العملاء والموردون (تقادم الديون) + الفواتير (بيع/شراء + TVA) + المخزون (متوسط التكلفة) + الرواتب الجزائرية (CNAS + IRG) + الميزانية (مقارنة بالفعلي) — اختصارات F10/F11/F12 + Ctrl+Shift+B/C/D — 1656 اختباراً ناجحاً + تغطية وحدات 100%',
        ...
        en: {
            ...
            intro: 'A complete accounting graduation project combining <strong>Artificial Intelligence</strong> and the <strong>Algerian Tax System</strong> — featuring 35 interactive screens, 20 financial ratios + Z-Score, and 1656 passing unit tests.',
            about_tag: 'About',
            ...
            about_card3_desc: '43 independent software modules — easy to extend, maintain, and develop',
            dev_title: 'Developer',
            ...
            modules_tag: 'Modules',
            modules_title: '43 Integrated Modules',
            ...
            mod18: 'General Ledger',
            mod18_desc: 'Journal entries + ledger + trial balance',
            mod19: 'Customers & Suppliers',
            mod19_desc: 'Partners + transactions + balances + aging',
            mod20: 'Invoices',
            mod20_desc: 'Sales/Purchases + items + VAT + statuses',
            mod21: 'Inventory',
            mod21_desc: 'Items + movements + average cost + alerts',
            mod22: 'Algerian Payroll',
            mod22_desc: 'Employees + CNAS + IRG + payslips',
            mod23: 'Budgeting',
            mod23_desc: 'Budget items + actuals comparison + variance',
            ...
            upd_date11: 'August 2, 2026',
            upd_new28: 'Phase 2 — 6 new accounting screens: General Ledger (trial balance) + Customers & Suppliers (aging) + Invoices (sales/purchases + VAT) + Inventory (average cost) + Algerian Payroll (CNAS + IRG) + Budgeting (actuals comparison) — shortcuts F10/F11/F12 + Ctrl+Shift+B/C/D — 1656 passing tests + 100% module coverage',
        ...
        fr: {
            ...
            intro: 'Projet de fin d\'étude comptable combinant <strong>l\'Intelligence Artificielle</strong> et le <strong>Système Fiscal Algérien</strong> — 35 écrans interactifs, 20 ratios financiers + Z-Score et 1656 tests unitaires réussis.',
            about_tag: 'À propos',
            ...
            about_card3_desc: '43 modules logiciels indépendants — facile à étendre et maintenir',
            ...
            modules_tag: 'Modules',
            modules_title: '43 Modules Intégrés',
            ...
            mod18: 'Grand Livre',
            mod18_desc: 'Écritures journal + grand livre + balance de vérification',
            mod19: 'Clients & Fournisseurs',
            mod19_desc: 'Partenaires + transactions + soldes + ancienneté',
            mod20: 'Factures',
            mod20_desc: 'Ventes/Achats + articles + TVA + statuts',
            mod21: 'Stock',
            mod21_desc: 'Articles + mouvements + coût moyen + alertes',
            mod22: 'Paie Algérienne',
            mod22_desc: 'Employés + CNAS + IRG + bulletins de paie',
            mod23: 'Budgétisation',
            mod23_desc: 'Postes budgétaires + comparaison réalisé + écarts',
            ...
            upd_date11: '2 Août 2026',
            upd_new28: 'Phase 2 — 6 nouveaux écrans comptables : Grand Livre (balance de vérification) + Clients & Fournisseurs (ancienneté des dettes) + Factures (ventes/achats + TVA) + Stock (coût moyen) + Paie Algérienne (CNAS + IRG) + Budgétisation (comparaison réalisé) — raccourcis F10/F11/F12 + Ctrl+Maj+B/C/D — 1656 tests réussis + couverture des modules 100%',
