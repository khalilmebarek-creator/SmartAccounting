...
def build():
    ...
    ar_para(doc, "الإصدار: v3.1.6", size=14, bold=True, space_after=4)
    ...
    ar_para(doc, "وصل المشروع إلى الإصدار v3.1.6 بعد جلسات تطوير متتالية أضافت ميزات متقدمة شملت تحليل DuPont، تحليل السيناريوهات، المعايير المرجعية، لوحة التحكم المتقدمة، الامتثال الضريبي الكامل، محرك الرؤى الذكية، تحليل مراكز التكلفة، تعدد العملات، المزامنة السحابية، والشركات التجريبية.")
    ...
    bullet(doc, "ح. توفير 1350 اختبار وحدة ناجحاً مع تغطية 100% للوحدات البرمجية")
    ...
    bullet(doc, "7. الاختبار والتحسين المستمر (1350 اختباراً + تغطية 100%)")
    ...
    ar_para(doc, "شملت جلسات التطوير الأخيرة (من v3.1.3 إلى v3.1.6) إضافة مجموعة من الميزات المتقدمة التي تُعدّ جوهر الابتكار في هذا المشروع:")
    ...
    bullet(doc, "1350 اختباراً ناجحاً مع تغطية 100% للوحدات")
    bullet(doc, "أداء محسّن: إقلاع 49ms وذاكرة 45MB")
    bullet(doc, "مثبت Inno Setup (63.2MB) ونسخة ZIP (41.4MB) وتحديث تلقائي مخفي")
    ...
    ar_para(doc, "تم تطوير المشروع وفق أفضل ممارسات هندسة البرمجيات، مع الالتزام بمبادئ الجودة والاختبار المستمر، مما نتج عنه 1350 اختبار وحدة ناجحاً وتغطية 100% للوحدات. كما تم توفير نظام تحديث تلقائي لتسهيل عملية التطوير والصيانة المستمرة.")
