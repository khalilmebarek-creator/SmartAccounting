...
def build():
    ...
    bullet(doc, "ح. توفير 1787 اختبار وحدة ناجحاً مع تغطية 100% للوحدات البرمجية")
    ...
    bullet(doc, "7. الاختبار والتحسين المستمر (1787 اختباراً + تغطية 100%)")
    ...
    bullet(doc, "1787 اختباراً ناجحاً + تغطية وحدات 100%")
    ...
    bullet(doc, "1787 اختباراً ناجحاً مع تغطية 100% للوحدات")
    ...
    ar_para(doc, "تم تطوير المشروع وفق أفضل ممارسات هندسة البرمجيات، مع الالتزام بمبادئ الجودة والاختبار المستمر، مما نتج عنه 1787 اختبار وحدة ناجحاً وتغطية 100% للوحدات. كما تم توفير نظام تحديث تلقائي لتسهيل عملية التطوير والصيانة المستمرة.")
