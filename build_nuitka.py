...
def main():
    ...
    cmd = [
        ...
        "--include-package=ui.views",
        "--include-package=ui.resources",
        "--include-package=modules",
        "--include-package=database",
        "--include-package=plotly",
        "--include-package=plotly.io",
        "--include-package=plotly.graph_objects",
        "--include-package=plotly.subplots",
        "--include-package=plotly.tools",
        "--include-package=sqlalchemy",
        "--include-package=sqlalchemy.dialects.sqlite",
        "--include-package=pyqtgraph",
        "--nofollow-import-to=tkinter,unittest,test,scipy,matplotlib,plotly.examples,plotly.tests,plotly.io._kaleido,pyqtgraph.examples,pyqtgraph.tests,numpy.random._examples",
